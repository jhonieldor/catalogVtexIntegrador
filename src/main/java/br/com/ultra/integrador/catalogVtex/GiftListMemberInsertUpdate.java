...
public class GiftListMemberInsertUpdate {
    ...
    @XmlElementRef(name = "giftListMember", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfGiftListMemberDTO> giftListMember;

    /**
     * Obtém o valor da propriedade giftListMember.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define o valor da propriedade giftListMember.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfGiftListMemberDTO }{@code >}
