...
/**
 * <p>Classe Java de StockKeepingUnitServiceDTO complex type.
 * 
...
public class StockKeepingUnitServiceDTO {
    ...
    @XmlElementRef(name = "ServiceId", namespace = "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> serviceId;
    @XmlElementRef(name = "ServicePrice", namespace = "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", type = JAXBElement.class, required = false)
    protected JAXBElement<ServicePriceDTO> servicePrice;
    @XmlElementRef(name = "ServicePriceId", namespace = "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", type = JAXBElement.class, required = false)
