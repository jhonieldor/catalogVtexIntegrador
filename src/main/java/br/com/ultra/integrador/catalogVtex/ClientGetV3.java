...
public class ClientGetV3 {
    ...
    @XmlElementRef(name = "idClientV3", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> idClientV3;

    /**
     * Obtém o valor da propriedade idClientV3.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define o valor da propriedade idClientV3.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
