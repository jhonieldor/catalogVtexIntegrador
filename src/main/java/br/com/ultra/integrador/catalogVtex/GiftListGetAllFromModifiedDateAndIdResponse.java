...
public class GiftListGetAllFromModifiedDateAndIdResponse {
    ...
    @XmlElementRef(name = "GiftListGetAllFromModifiedDateAndIdResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfGiftListDTO> giftListGetAllFromModifiedDateAndIdResult;

    /**
     * Obtém o valor da propriedade giftListGetAllFromModifiedDateAndIdResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define o valor da propriedade giftListGetAllFromModifiedDateAndIdResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfGiftListDTO }{@code >}
    ...
    public void setGiftListGetAllFromModifiedDateAndIdResult(JAXBElement<ArrayOfGiftListDTO> value) {
        this.giftListGetAllFromModifiedDateAndIdResult = value;
    }
