...
public class WareHouseIStockableGetByStockKeepingUnitResponse {
    ...
    @XmlElementRef(name = "WareHouseIStockableGetByStockKeepingUnitResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WareHouseIStockableDTO> wareHouseIStockableGetByStockKeepingUnitResult;

    /**
     * Obtém o valor da propriedade wareHouseIStockableGetByStockKeepingUnitResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define o valor da propriedade wareHouseIStockableGetByStockKeepingUnitResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link WareHouseIStockableDTO }{@code >}
    ...
    public void setWareHouseIStockableGetByStockKeepingUnitResult(JAXBElement<WareHouseIStockableDTO> value) {
        this.wareHouseIStockableGetByStockKeepingUnitResult = value;
    }
