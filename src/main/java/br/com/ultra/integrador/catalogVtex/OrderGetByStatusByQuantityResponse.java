...
public class OrderGetByStatusByQuantityResponse {
    ...
    @XmlElementRef(name = "OrderGetByStatusByQuantityResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfOrderDTO> orderGetByStatusByQuantityResult;

    /**
     * Obtém o valor da propriedade orderGetByStatusByQuantityResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define o valor da propriedade orderGetByStatusByQuantityResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfOrderDTO }{@code >}
    ...
    public void setOrderGetByStatusByQuantityResult(JAXBElement<ArrayOfOrderDTO> value) {
        this.orderGetByStatusByQuantityResult = value;
    }
